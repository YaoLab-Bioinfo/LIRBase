...
- [**1. Browse LIRBase**](#tp1)
- [**2. Search LIRBase by genomic locations**](#tp2)
- [**3. Search LIRBase by the ID of LIRs**](#tp3)
- [**4. Search LIRBase using BLAST**](#tp4)
- [**5. Annotate LIRs in user-uploaded DNA sequences**](#tp5)
- [**6. Identify candidate LIRs encoding long hpRNAs by aligning sRNA sequencing data to LIRs**](#tp6)
